            ...
            <div class="container mx-auto px-4 ">
                <div class="flex items-center justify-between py-4">
                    ...
                    <nav class="hidden md:flex items-center space-x-6">
                        <a href="../index.php"
                            class="text-blue-400 font-bold hover:text-blue-500 transition-colors">Home</a>
                        <a href="./courses.php"
        ...
        <section class="hero flex flex-row items-center justify-center mt-24">
            ...
            <div class="flex flex-col justify-start">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="./contact.php"
                        class="px-6 py-3 bg-white border border-blue-400 text-blue-400 font-semibold rounded-full  hover:bg-blue-400 hover:text-white transition">
                        Contact Support
                    </a>
                </div>
            </div>
