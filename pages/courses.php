        ...
        <div class="py-10 md:px-12 px-6">
                        ...
                        <div
                            ...
                            <div class="py-3">
                                ...
                                <div class="flex items-center justify-between mt-3">
                                    <p class="text-blue-400 font-bold"><?= htmlspecialchars($course['price']); ?> $</p>
            ...
            <div class="flex justify-center mt-6">
                <nav class="inline-flex items-center space-x-2">
                    <?php if ($page > 1): ?>
                        <a href="?page=<?= $page - 1 ?>"
                            class="px-4 py-2 bg-blue-400 text-white rounded-lg hover:bg-blue-500">Previous</a>
                    <?php endif; ?>

                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        <a href="?page=<?= $i ?>"
                            class="px-4 py-2 <?= $i == $page ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-800' ?> rounded-lg hover:bg-blue-400 hover:text-white"><?= $i ?></a>
                    <?php endfor; ?>

                    <?php if ($page < $totalPages): ?>
                        <a href="?page=<?= $page + 1 ?>"
                            class="px-4 py-2 bg-blue-400 text-white rounded-lg hover:bg-blue-500">Next</a>
                    <?php endif; ?>
                </nav>
            </div>
        </div>
