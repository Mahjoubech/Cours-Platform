    ...
    <section>
        <div class="py-10 md:px-12 px-6">
            <h2 class="text-4xl font-bold text-gray-800 mb-6 text-center md:mb-11">
                Explore Your <span class="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">Courses</span>
            </h2>
                        ...
                        <div class="bg-white border border-blue-400 rounded-lg shadow-md p-4 hover:scale-105 transition-transform">
                            ...
                            <div class="py-3">
                                ...
                                <p class="text-sm text-gray-500">Created By <span class="font-bold"><?= htmlspecialchars($course['instructorName']) ?></span></p>
                                    <a href="course-view.php?id=<?= htmlspecialchars($course['id']); ?>" class="font-bold underline text-blue-400">
                                        View Course
                                    </a>
                                </div>
                            </div>
