...
<body>
                ...
                <div class="flex items-center justify-between py-4">
                    ...
                    <nav class="hidden md:flex items-center space-x-6">
                        <?php foreach ($menuItems as $item): ?>
                            <a href="<?= $item[1] ?>" class="text-gray-900 hover:text-blue-500 transition-colors">
                                <?= $item[0] ?>
                            </a>
                        <?php endforeach; ?>
                    </nav>
            ...
            <div class="w-[30%]">
                <div>
                    <div class="bg-white rounded-lg border shadow-sm p-6 ">
                        <div>
                            <div class="mb-8">
                                <h3 class="font-semibold mb-2 text-xl border-b pb-3 text-blue-400">Course Info</h3>
                            ...
                            <div>
                                <div>
                                    <h3 class="font-semibold mb-2 text-xl border-b pb-3 text-blue-400">Instructor</h3>
                    ...
                    <div class="bg-white rounded-lg border shadow-sm p-6 mt-4 pb-10">
                        <h2 class="text-lg font-semibold mb-4 text-blue-400 border-b pb-3">Mark Your Course Progress</h2>
                        <form action="submitProgress.php" method="POST">
                            ...
                            <button type="submit"
                                class="mt-6 bg-blue-400 w-full text-white px-4 py-2 rounded-lg hover:bg-green-700 hover:text-white">Submit</button>
                        </form>
                    </div>
    ...
    <?php elseif ($courseType === 'document'): ?>
        ...
        <div class="sm:px-6 lg:px-8 py-4 w-full flex gap-4">
            <!-- document view -->
            <div class="w-[70%] border p-2 rounded-lg shadow-sm px-6 pb-8 pt-6">
                <h3 class="font-semibold text-xl pb-3 border-b text-blue-400 mb-5">Course Document</h3>
                <div class="relative aspect-video rounded-lg overflow-hidden ">
