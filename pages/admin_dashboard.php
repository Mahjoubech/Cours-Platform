    ...
    <div class="flex h-screen">
        <aside class="w-64 bg-gray-900 text-white">
            <div class="p-4">
                ...
                <nav class="space-y-1">
                    <a href="./admin_dashbord.php" class="flex items-center gap-3 px-3 py-2 text-sm text-blue-400 rounded-md bg-gray-800">
                    ...
                    <a href="./tags_dashbord.php" class="flex items-center gap-3 px-3 py-2 text-sm text-gray-400 hover:bg-gray-800 rounded-md">
                ...
                <div class="flex items-center justify-between max-w-7xl mx-auto">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Search for courses" class="bg-gray-100 rounded-md pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        <button class="bg-blue-50 text-blue-600 px-4 py-2 rounded-md text-sm font-medium">Enter</button>
                ...
                <div class="grid grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm">
                        ...
                        <div class="flex items-center justify-center h-64">
                            <div class="relative w-40 h-40 rounded-full border-8 border-blue-400">
