        ...
        <form class="space-y-6" method="POST" enctype="multipart/form-data" action="addCourse.php">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3" required value=""
                    class="mt-1 block w-full rounded-md border border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo htmlspecialchars($courseDetails['description']); ?></textarea>
            </div>
            ...
            <div id="available-tags" class="space-y-2 space-x-1">
                ...
                foreach ($tags as $tag) {
                    ...
                    echo "<div class='tag-item space-x-2 inline-block p-2 px-4 border border-blue-400 rounded-full cursor-pointer hover:bg-blue-400' data-tag-id='" . $tag['id'] . "' data-selected='$isSelected'>
            ...
            <div id="selected-tags" class="space-y-2 space-x-1">
                ...
                foreach ($selectedTags as $tag) {
                    echo "<div class='tag-item space-x-2 inline-block p-2 px-4 border border-blue-400 rounded-full bg-blue-400 text-white' data-tag-id='" . $tag['id'] . "'>
                  <span class='tag-name'>" . htmlspecialchars($tag['name']) . "</span>
